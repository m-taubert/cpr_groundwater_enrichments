...
############################ Select treatment
AsvSelect <- Asvall_RAFilter02[grep("^autotrophy$", Asvall_RAFilter02$Csource, ignore.case = TRUE), ]
...
#save(funyG, file = "sparcc/funyGautotrophy.RData")

# this code takes a long time to run, please use the provided .RData files instead
#net <-sparcc(funyG)
#save(net, file = "sparcc/netautotrophy.RData")

############################# continue with saved results
load("sparcc/netautotrophy.RData")
...
targetnode_filter <- c("Gammaproteobacteria_Burkholderiales","Nitrospirota_Thermodesulfovibrionia","Campylobacteria_Campylobacterales","Alphaproteobacteria_Rhodobacterales","Gammaproteobacteria_Acidiferrobacterales","Gammaproteobacteria_Pseudomonadales","WPS.2_NA","Alphaproteobacteria_Caulobacterales","Alphaproteobacteria_Reyranellales","Alphaproteobacteria_Rickettsiales","Anaerolineae_RBG.13","Bacteroidia_Chitinophagales","Brocadiae_Brocadiales","Chlamydiae_Chlamydiales")
# Create a named vector of colors for the sectors
color_assignments <- list("Parcubacteria" = "#BF0000","Gracilibacteria" = "#739900","Saccharimonadia" = "#0056BE","ABY1" = "#BF7300","Gammaproteobacteria" = "#538B8B","Alphaproteobacteria" = "#88789b","Bacteroidia" = "#e75480","Verrucomicrobiae" = "#FFB6C1","Chlamydiae" = "#F0E68C","Acidimicrobiia|Blastocatellia" = "darkslateblue","Planctomycetes" = "darkgreen","Nitrospirota|Nitrospiria" = "#96a9c6","WPS" = "#3F4041","Chloroflexi" = "bisque4","Berkelbacteria" = "darkslategrey","Cyanobacteria" = "darkseagreen","Actinobacteria|Actinomycetota" = "#8B7D6B","Thermoleophilia"= "#CDC0B0","Bdellovibrionia" ="#8B8970","Omnitrophia" = "bisque4","Brocadiae" = "#8A2BE2","Vampirivibrionia" = "#8B8970","Polyangia" = "#4682B4","Hydrogenedentia" = "#8B8878","Latescibacterota" ="#8B795E","Campylobacteria" ="#8B7D7B","WPS" ="#8B7D7B","Anaerolineae" ="#3E2723")

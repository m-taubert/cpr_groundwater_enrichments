...
############################ Select treatment
AsvSelect <- Asvall_RAFilter02[grep("^methylotrophy$", Asvall_RAFilter02$Csource, ignore.case = TRUE), ]
...
targetnode_filter <- c("Alphaproteobacteria_Rhizobiales","Bacteroidia_Chitinophagales","Alphaproteobacteria_Caulobacterales","Bacteroidia_Sphingobacteriales","Gammaproteobacteria_Burkholderiales","Gammaproteobacteria_Pseudomonadales","Phycisphaerae_Phycisphaerales","Alphaproteobacteria_Reyranellales","Alphaproteobacteria_Sphingomonadales","Blastocatellia_11","Planctomycetes_Planctomycetales","Verrucomicrobiae_Chthoniobacterales","Verrucomicrobiae_Pedosphaerales","Alphaproteobacteria_Azospirillales","Alphaproteobacteria_Rhodospirillales","Omnitrophia_Omnitrophales","Vampirivibrionia_Obscuribacterales")
# Create a named vector of colors for the sectors
color_assignments <- list("Parcubacteria" = "#BF0000","Gracilibacteria" = "#739900","Saccharimonadia" = "#0056BE","ABY1" = "#BF7300","Gammaproteobacteria" = "#538B8B","Alphaproteobacteria" = "#88789b","Bacteroidia" = "#e75480","Verrucomicrobiae" = "#FFB6C1","Chlamydiae" = "#F0E68C","Acidimicrobiia|Blastocatellia" = "darkslateblue","Planctomycetes" = "darkgreen","Nitrospirota|Nitrospiria" = "#96a9c6","WPS" = "#7F798F","Chloroflexi" = "bisque4","Berkelbacteria" = "darkslategrey","Cyanobacteria" = "darkseagreen","Actinobacteria|Actinomycetota" = "#8B7D6B","Thermoleophilia"= "#CDC0B0","Bdellovibrionia" ="#8B8970","Omnitrophia" = "bisque4","Brocadiae" = "#8A2BE2","Vampirivibrionia" = "#8B8970","Polyangia" = "#4682B4","Hydrogenedentia" = "#8B8878","Latescibacterota" ="#8B795E","Campylobacteria" ="#8B7D7B","Phycisphaerae"  ="#858F94")

...
############################ Select treatment
AsvSelect <- Asvall_RAFilter02[grep("^organic_undefined$", Asvall_RAFilter02$Csource, ignore.case = TRUE), ]
...
#save(funyG, file = "sparcc/funyGComplex.RData")

# this code takes a long time to run, please use the provided .RData files instead
#net <-sparcc(funyG)
#save(net, file = "sparcc/netorganic_undefined.RData")

####################################################### Plot
load("sparcc/netorganic_undefined.RData")
...
targetnode_filter <- c("Alphaproteobacteria_Caulobacterales","Alphaproteobacteria_Rhizobiales","Alphaproteobacteria_Rickettsiales","Alphaproteobacteria_Sphingomonadales","Bacteroidia_Chitinophagales","Bacteroidia_Cytophagales","Bacteroidia_Flavobacteriales","Bacteroidia_Sphingobacteriales","Blastocatellia_Blastocatellales","Gammaproteobacteria_Burkholderiales","Gammaproteobacteria_Pseudomonadales","Gammaproteobacteria_Xanthomonadales","Nitrospiria_Nitrospirales","Planctomycetes_Gemmatales","Planctomycetes_Pirellulales","Planctomycetota_OM190","Verrucomicrobiae_Pedosphaerales")
